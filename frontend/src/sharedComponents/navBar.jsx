    ...
    <>
      <header>
        <nav className="bg-[#f6f5f4] h-[81px] border-b-1 border-[#e8e6e3]">
          <div className="mr-auto ml-auto px-[140px] h-full flex items-center justify-center">
            <div className="flex    ">
              ...
              <ul className="flex">
                ...
                <li className="px-[12px] h-[42px] flex flex-col items-center justify-center ">
                  ...
                  <span className="text-[14px]">Favourites</span>
                </li>
                <li className="px-[12px] h-[42px] flex flex-col items-center justify-center ">
                  <img src={startListing} className="h-[16px] w-[16px]" />
                  <span className="text-[14px]">Start a listing</span>
                </li>
                <li className="px-[12px] h-[42px] flex flex-col items-center justify-center ">
                  <img src={categories} className="h-[16px] w-[16px]" />
                  <span className="text-[14px]">My Trade Me</span>
                </li>
              </ul>
            </div>
          </div>
